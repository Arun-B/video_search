...
<html lang="en">
  <head>
    ...
    <title>Flixnet : Home</title>
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/icon" href="main_assets/images/favicon.ico"/>
    <!-- Font Awesome -->
    <link href="main_assets/css/font-awesome.css" rel="stylesheet">
    <!-- Bootstrap -->
    <link href="main_assets/css/bootstrap.css" rel="stylesheet">
    <!-- Slick slider -->
    <link rel="stylesheet" type="text/css" href="main_assets/css/slick.css"/>
    <!-- Fancybox slider -->
    <link rel="stylesheet" href="main_assets/css/jquery.fancybox.css" type="text/css" media="screen" />
    <!-- Animate css -->
    <link rel="stylesheet" type="text/css" href="main_assets/css/animate.css"/>
     <!-- Theme color -->
    <link id="switcher" href="main_assets/css/theme-color/default.css" rel="stylesheet">
    <!-- Main Style -->
    <link href="main_assets/style.css" rel="stylesheet">
  ...
  <header id="header">
    <div class="header-inner">
      <!-- Header image -->
      <img src="main_assets/images/header-bg.jpg" alt="img">
      <div class="header-overlay">
        <div class="header-content">
        <!-- Start header content slider -->
        <h2 class="header-slide">STREAM
          <span>MOVIES</span>
          <span>TV SHOWS</span>
          AND MUCH MORE</h2>
        ...
        <div class="header-btn-area">
          ...
          <a class="download-btn" href="login">SIGN IN</a>
        </div>
      </div>
      </div>
    </div>
    ...
    <nav class="navbar navbar-default main-navbar" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->
           <a class="navbar-brand logo" href="index"><img src="main_assets/images/logo.jpg" alt="logo"></a>
        </div>
        ...
        <div class="col-md-12">
          ...
          <div class="welcome-area">
            <div class="title-area">
              <h2 class="tittle">Welcome to <span>Flixnet</span></h2>
              <span class="tittle-line"></span>
              <p>The greatest movie streaming service on the planet. I don't think they can get any better than this.</p>
            </div>
            ...
            <div class="row">
              <div class="col-md-5 col-sm-6 col-xs-12">
                <div class="about-left wow fadeInLeft">
                  <img src="main_assets/images/about-img.jpg" alt="img">
  ...
  <section id="call-to-action">
    <img src="main_assets/images/call-to-action-bg.png" alt="img">
              ...
              <ul class="team-grid">
                ...
                <li>
                  ...
                  <div class="team-item team-img-4 wow fadeInUp">
                    <div class="team-info">
                      <p> I'm the one who does all the work here</p>
                      <a href="#"><span class="fa fa-facebook"></span></a>
                      <a href="#"><span class="fa fa-twitter"></span></a>
                      <a href="#"><span class="fa fa-pinterest"></span></a>
                      <a href="#"><span class="fa fa-rss"></span></a>
            ...
            <div class="pricing-table-content">
                <ul class="price-table">
                  <li class="wow slideInUp">
                    <div class="single-price">
                      ...
                      <span class="price-amount">Rs500.00/mo</span>
                      <p>Standard Def.</p>
                  ...
                  <li class="wow slideInUp">
                    <div class="single-price standard-price">
                      ...
                      <span class="price-amount">Rs650.00/mo</span>
                      <p>High Def.</p>
                  ...
                  <li class="wow slideInUp">
                    <div class="single-price">
                      ...
                      <span class="price-amount">Rs800.00/mo</span>
                      <p>High Def.</p>
                      <p>3 Screens at a time</p>
                      <p>Cancel Anytime</p>
                      <p>Unlimited access</p>
                      <p>1 Month Free</p>
                      <a data-text="SIGN UP" class="button button-default" href="#"><span>SIGN UP</span></a>
                ...
                <li class="wow slideInUp">
                    <div class="single-price">
                      ...
                      <span class="price-amount">Rs900.00/mo</span>
                      <p>Ultra High Def.</p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="footer-top-area">
                <a class="footer-logo" href="#"><img src="main_assets/images/logo.jpg" alt="Logo"></a>
  ...
  <!-- Bootstrap -->
  <script src="main_assets/js/bootstrap.js"></script>
  <!-- Slick Slider -->
  <script type="text/javascript" src="main_assets/js/slick.js"></script>
  <!-- Counter -->
  <script type="text/javascript" src="main_assets/js/waypoints.js"></script>
  <script type="text/javascript" src="main_assets/js/jquery.counterup.js"></script>
  <!-- mixit slider -->
  <script type="text/javascript" src="main_assets/js/jquery.mixitup.js"></script>
  <!-- Add fancyBox -->
  <script type="text/javascript" src="main_assets/js/jquery.fancybox.pack.js"></script>
  <!-- Wow animation -->
  <script type="text/javascript" src="main_assets/js/wow.js"></script>
  <!-- Custom js -->
  <script type="text/javascript" src="main_assets/js/custom.js"></script>
  </body>
</html>
